...
function loadStatsPage()
{
	...
	var opp = 0;
	var team = "";
	var table2 = document.getElementById("record");
	...
	{//Outer for loop iterates over each row
		...
		home = parseInt(table.rows[row_counter].cells[2].innerHTML);//Read in a cells current value
	...
	table2.rows[1].cells[0].innerHTML = wins;
	table2.rows[1].cells[1].innerHTML = loss;
